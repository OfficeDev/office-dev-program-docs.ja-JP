...
ms.locfileid: "68667286"
---
# <a name="set-up-a-microsoft-365-developer-sandbox-subscription"></a>Microsoft 365 開発者サンドボックス サブスクリプションの設定 

運用環境に依存しないソリューションを構築するための Microsoft 365 開発者サンドボックスを設定します。 通常のメンバーまたは Visual Studio エンタープライズを通じて参加する開発者プログラム メンバーシップには、25 ユーザー ライセンス付のMicrosoft 365 E5 開発者サンドボックス サブスクリプションが含まれています。 90日間有効で、開発目的 (コーディングのソリューション) のみに無料で使用できます。 有料サービスの購入を含む商用トランザクションはサポートされていません。
